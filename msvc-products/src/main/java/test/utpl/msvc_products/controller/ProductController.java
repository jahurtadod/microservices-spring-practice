package test.utpl.msvc_products.controller;
...
import test.utpl.msvc_products.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<?> importProducts(@RequestParam("file") MultipartFile file) {
        ...
        // TODO Agregar validación para el mensaje de error
        if (result.startsWith("El archivo CSV debe contener")) {
